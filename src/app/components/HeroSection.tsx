...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0a0118] via-[#1a0b2e] to-[#0f0520]">
      {/* Ambient light effects */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-cyan-500/20 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        <motion.div
          ...
          className="mb-6"
        >
          {/* <div className="inline-block px-4 py-2 bg-gradient-to-r from-purple-500/20 to-cyan-500/20 backdrop-blur-sm border border-purple-500/30 rounded-full mb-8">
        ...
        <motion.h1
          ...
          className="mb-6 text-6xl md:text-7xl lg:text-8xl font-bold leading-tight"
        >
        ...
        <motion.p
          ...
          className="mb-12 text-xl md:text-2xl text-purple-200/80 max-w-3xl mx-auto leading-relaxed"
        >
